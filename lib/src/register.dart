  ...
  void _loadSettings() async {
    ...
    setState(() {
      _wsUriController.text =
          _preferences.getString('ws_uri') ?? 'wss://ems.logicmarkcloud.com:7443/ws';
      _sipUriController.text =
          _preferences.getString('sip_uri') ?? 'sip:3e1c89c7-c6b7-4b5c-8864-ab0bb6865580@ems.logicmarkcloud.com';
      _displayNameController.text =
          _preferences.getString('display_name') ?? 'Flutter SIP UA';
      _passwordController.text = _preferences.getString('password') ?? '%9HWuwO8Wk&v';
      _authorizationUserController.text =
          _preferences.getString('auth_user') ?? '3e1c89c7-c6b7-4b5c-8864-ab0bb6865580';
    });
  }
